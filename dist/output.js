...
exports["default"] = all;
var _createChainableTypeChecker = __webpack_require__(543);
...
var runtime = __webpack_require__(518)();
...
/******/ 	!function() {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "todolist-router-64:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunktodolist_router_64"] = self["webpackChunktodolist_router_64"] || [];
...
function stripHashFromPath(path) {
  ...
  return createPath(router_extends({}, parsedPath, {
    hash: ""
  }));
}
...
function getFormSubmissionInfo(target, basename) {
  ...
  if (isFormElement(target)) {
    ...
    action = attr ? router_stripBasename(attr, basename) : null;
...
function useSubmitFetcher(fetcherKey, fetcherRouteId) {
  ...
  return react.useCallback(function (target, options) {
    ...
    !(fetcherRouteId != null) ?  false ? 0 : router_invariant(false) : void 0;
...
function useFormAction(action, _temp2) {
  ...
  !routeContext ?  false ? 0 : router_invariant(false) : void 0;
...
function useFetcher() {
  ...
  !(routeId != null) ?  false ? 0 : router_invariant(false) : void 0;
  let [fetcherKey] = react.useState(() => String(++fetcherId));
  let [Form] = react.useState(() => {
    !routeId ?  false ? 0 : router_invariant(false) : void 0;
    return createFetcherForm(fetcherKey, routeId);
  });
  let [load] = react.useState(() => href => {
    !router ?  false ? 0 : router_invariant(false) : void 0;
    !routeId ?  false ? 0 : router_invariant(false) : void 0;
...
;// CONCATENATED MODULE: ./src/assets/To_Do_List.webp
/* harmony default export */ var To_Do_List = (__webpack_require__.p + "images/To_Do_List.webp");
...
var Home = function Home() {
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("h1", null, "Home"), /*#__PURE__*/react.createElement(esm_Figure, null, /*#__PURE__*/react.createElement(esm_Figure.Image, {
    ...
    to: "/todolist"
  }, "Todo List"), /*#__PURE__*/react.createElement("br", null), /*#__PURE__*/react.createElement("br", null), /*#__PURE__*/react.createElement(react_bootstrap_esm_Button, {
    variant: "secondary",
    onClick: RedirectToddolist
  }, "Todo List"));
};
...
var regenerator = __webpack_require__(117);
...
;// CONCATENATED MODULE: ./node_modules/react-bootstrap-icons/dist/icons/pencil-square.js
var pencil_square_excluded = ["color", "size", "title"];
function pencil_square_extends() {
  pencil_square_extends = Object.assign || function (target) {
    for (var i = 1; i < arguments.length; i++) {
      var source = arguments[i];
      for (var key in source) {
        if (Object.prototype.hasOwnProperty.call(source, key)) {
  ...
  return pencil_square_extends.apply(this, arguments);
}
function _objectWithoutProperties(source, excluded) {
  if (source == null) return {};
  var target = pencil_square_objectWithoutPropertiesLoose(source, excluded);
  var key, i;
...
function pencil_square_objectWithoutPropertiesLoose(source, excluded) {
  if (source == null) return {};
  var target = {};
  var sourceKeys = Object.keys(source);
  var key, i;
...
var PencilSquare = /*#__PURE__*/(0,react.forwardRef)(function (_ref, ref) {
  var color = _ref.color,
    size = _ref.size,
    title = _ref.title,
    rest = _objectWithoutProperties(_ref, pencil_square_excluded);
  return /*#__PURE__*/react.createElement("svg", pencil_square_extends({
    ref: ref,
...
/* harmony default export */ var pencil_square = (PencilSquare);
;// CONCATENATED MODULE: ./node_modules/react-bootstrap-icons/dist/icons/trash3-fill.js
var trash3_fill_excluded = ["color", "size", "title"];
function trash3_fill_extends() {
  trash3_fill_extends = Object.assign || function (target) {
    for (var i = 1; i < arguments.length; i++) {
      var source = arguments[i];
      for (var key in source) {
        if (Object.prototype.hasOwnProperty.call(source, key)) {
  ...
  return trash3_fill_extends.apply(this, arguments);
}
function trash3_fill_objectWithoutProperties(source, excluded) {
  if (source == null) return {};
  var target = trash3_fill_objectWithoutPropertiesLoose(source, excluded);
  var key, i;
  if (Object.getOwnPropertySymbols) {
    var sourceSymbolKeys = Object.getOwnPropertySymbols(source);
    for (i = 0; i < sourceSymbolKeys.length; i++) {
...
function trash3_fill_objectWithoutPropertiesLoose(source, excluded) {
  if (source == null) return {};
  var target = {};
  var sourceKeys = Object.keys(source);
  var key, i;
...
var Trash3Fill = /*#__PURE__*/(0,react.forwardRef)(function (_ref, ref) {
  var color = _ref.color,
    size = _ref.size,
    title = _ref.title,
    rest = trash3_fill_objectWithoutProperties(_ref, trash3_fill_excluded);
  return /*#__PURE__*/react.createElement("svg", trash3_fill_extends({
    ref: ref,
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 16 16",
    width: size,
...
/* harmony default export */ var trash3_fill = (Trash3Fill);
;// CONCATENATED MODULE: ./src/pages/TodoListPage.js
...
function TodoListPage() {
  var numbFormate = function numbFormate(n) {
    return n > 9 ? "" + n : "0" + n;
  };
  ...
  var _useState3 = (0,react.useState)(true),
    ...
    allTodoFilter = _useState4[0],
    setAllTodoFilter = _useState4[1];
  var _useState5 = (0,react.useState)(false),
    _useState6 = _slicedToArray(_useState5, 2),
    doneTodoFilter = _useState6[0],
    setDoneTodoFilter = _useState6[1];
  var _useState7 = (0,react.useState)(false),
    _useState8 = _slicedToArray(_useState7, 2),
    activeTodoFilter = _useState8[0],
    setActiveTodoFilter = _useState8[1];
  var filteredData = '';
  var submit = useSubmit();
  var deleteTodo = function deleteTodo(todo) {
    //console.log(todo.currentTarget.dataset.id);
    var processDelete = window.confirm("are you sure?");
    if (processDelete) {
      submit({
        id: todo.currentTarget.dataset.id
      }, {
        method: 'DELETE'
      });
    }
  };
  var allTodoData = function allTodoData() {
    setAllTodoFilter(true);
    setDoneTodoFilter(false);
    setActiveTodoFilter(false);
  };
  var doneTodoData = function doneTodoData() {
    setAllTodoFilter(false);
    setDoneTodoFilter(true);
    setActiveTodoFilter(false);
  };
  var activeTodoData = function activeTodoData() {
    setAllTodoFilter(false);
    setDoneTodoFilter(false);
    setActiveTodoFilter(true);
  };
  filteredData = allTodoFilter ? allTodoListData.filter(function (filterData) {
    return filterData.date > '1971-01-01';
  }) : doneTodoFilter ? allTodoListData.filter(function (filterData) {
    return filterData.date < combDate;
  }) : activeTodoFilter ? allTodoListData.filter(function (filterData) {
    return filterData.date >= combDate;
  }) : 'No todo list found.';
  ...
  }, /*#__PURE__*/react.createElement(esm_ButtonGroup, {
    className: "mb-2 ms-auto"
  }, /*#__PURE__*/react.createElement(react_bootstrap_esm_Button, {
    variant: "secondary",
    className: "px-5",
    onClick: allTodoData
  }, "All"), /*#__PURE__*/react.createElement(react_bootstrap_esm_Button, {
    variant: "secondary",
    className: "px-5",
    onClick: doneTodoData
  }, "Done"), /*#__PURE__*/react.createElement(react_bootstrap_esm_Button, {
    variant: "secondary",
    className: "px-5",
    onClick: activeTodoData
  }, "Todo"))))), /*#__PURE__*/react.createElement(esm_Container, null, /*#__PURE__*/react.createElement(esm_Stack, {
    gap: 3,
    className: "mt-5"
  }, filteredData.map(function (toList) {
    return /*#__PURE__*/react.createElement("div", {
      key: toList.id,
      className: "px-2 py-3 border-gray rounded"
    }, /*#__PURE__*/react.createElement(esm_Container, null, /*#__PURE__*/react.createElement(esm_Row, {
      className: "row justify-content-around text-capitalize"
    }, /*#__PURE__*/react.createElement(esm_Col, {
      className: "col-md-8 fs-6 fw-normal"
    }, /*#__PURE__*/react.createElement(Link, {
      to: toList.id,
      className: "anchortodo"
    }, toList.title)), /*#__PURE__*/react.createElement(esm_Col, {
      className: "col-md-2 fs-6"
    }, toList.date), /*#__PURE__*/react.createElement(esm_Col, {
      className: "col-md-2 fs-6"
    }, /*#__PURE__*/react.createElement(Link, {
      to: "".concat(toList.id, "/edit")
    }, /*#__PURE__*/react.createElement(pencil_square, {
      className: "pencil"
    })), /*#__PURE__*/react.createElement("div", {
      className: "vr text-white px-2"
    }), /*#__PURE__*/react.createElement(trash3_fill, {
      onClick: deleteTodo,
      "data-id": toList.id,
      className: "remove"
    })))));
...
var action = function action(_x) {
  return (_ref3 = _ref3 || _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee2(_ref2) {
    var request, params, fmData, method, todoId, response;
    return regenerator_default().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          fmData = _context2.sent;
          method = request.method;
          todoId = fmData.get("id");
          _context2.next = 8;
        ...
        case 13:
          return _context2.abrupt("return", redirect("/todolist/"));
        case 14:
        case "end":
...
var warning_warning = __webpack_require__(365);
...
/* harmony default export */ var esm_Form = (Object.assign(Form_Form, {
  Group: esm_FormGroup,
...
;// CONCATENATED MODULE: ./src/component/FormTodo.js
...
function FormTodo(_ref) {
  var method = _ref.method,
    todo = _ref.todo;
  var actionData = useActionData();
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(esm_Container, null, actionData ? /*#__PURE__*/react.createElement(esm_Row, null, /*#__PURE__*/react.createElement(esm_Col, {
    className: "error p-2"
  }, /*#__PURE__*/react.createElement("ul", null, Object.values(actionData === null || actionData === void 0 ? void 0 : actionData.errors).map(function (err) {
    return /*#__PURE__*/react.createElement("li", {
      key: err
    }, err);
  })))) : '', /*#__PURE__*/react.createElement(Form, {
    method: method
  }, /*#__PURE__*/react.createElement(esm_Form.Group, {
    className: "mb-3",
    controlId: "exampleForm.ControlInput1"
  }, /*#__PURE__*/react.createElement(esm_Form.Label, null, "Title"), /*#__PURE__*/react.createElement(esm_Form.Control, {
    type: "text",
    name: "title",
    defaultValue: todo === null || todo === void 0 ? void 0 : todo.todolist.title
  })), /*#__PURE__*/react.createElement(esm_Form.Group, {
    className: "mb-3",
    controlId: "exampleForm.ControlTextarea1"
  }, /*#__PURE__*/react.createElement(esm_Form.Label, null, "Description"), /*#__PURE__*/react.createElement("textarea", {
    rows: "3",
    name: "description",
    id: "exampleForm.ControlTextarea1",
    className: "form-control",
    defaultValue: todo === null || todo === void 0 ? void 0 : todo.todolist.description
  })), /*#__PURE__*/react.createElement(esm_Form.Group, {
    className: "mb-3",
    controlId: "exampleForm.ControlInput2"
  }, /*#__PURE__*/react.createElement(esm_Form.Label, null, "Date"), /*#__PURE__*/react.createElement(esm_Form.Control, {
    type: "date",
    name: "date",
    defaultValue: todo === null || todo === void 0 ? void 0 : todo.todolist.date
  })), /*#__PURE__*/react.createElement(react_bootstrap_esm_Button, {
    variant: "primary",
    type: "submit"
  }, "Submit"))));
}
var FormTodo_action = function action(_x) {
  return (FormTodo_ref3 = FormTodo_ref3 || _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee(_ref2) {
    var request, params, data, bodyData, url, response;
    return regenerator_default().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          request = _ref2.request, params = _ref2.params;
        ...
        case 12:
          ...
          throw new Response(JSON.stringify({
            message: 'Todo not submitted...'
          }), {
            status: 500
          });
        case 14:
          return _context.abrupt("return", redirect("/todolist"));
        case 15:
        case "end":
          return _context.stop();
      }
...
;// CONCATENATED MODULE: ./src/pages/AddTodoListPage.js



function AddTodoListPage() {
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(esm_Container, null, /*#__PURE__*/react.createElement("h1", {
    className: "text-center text-capitalize fw-normal fs-2 mb-5"
  }, "Add Todo")), /*#__PURE__*/react.createElement(FormTodo, {
    method: "POST"
  }));
}
// EXTERNAL MODULE: ./node_modules/prop-types-extra/lib/all.js
var lib_all = __webpack_require__(633);
...
/* harmony default export */ var esm_NavLink = (NavLink_NavLink);
...
function Header() {
  return /*#__PURE__*/react.createElement(esm_Container, {
    fluid: true,
    className: "bgblue"
  }, /*#__PURE__*/react.createElement(esm_Container, null, /*#__PURE__*/react.createElement(esm_Stack, {
    direction: "horizontal",
    gap: 3
  }, /*#__PURE__*/react.createElement(esm_Navbar.Brand, {
    className: "p-2 text-white navlogo"
  }, /*#__PURE__*/react.createElement(NavLink, {
    className: function className(_ref) {
      var isActive = _ref.isActive;
      return isActive ? 'active text-white' : 'inactive text-white';
    },
    to: "/",
    end: true
  }, "Logo")), /*#__PURE__*/react.createElement(react_bootstrap_esm_Nav, {
    ...
    to: "addtodolist"
  }, "Add List"), /*#__PURE__*/react.createElement("div", {
    className: "vr text-white"
  }), /*#__PURE__*/react.createElement(NavLink, {
...
function Footer() {
  return /*#__PURE__*/react.createElement(esm_Container, {
    fluid: true,
    className: "footer px-4 py-3 text-center fw-normal text-white text-captilize footer mt-3"
  }, /*#__PURE__*/react.createElement(esm_Row, null, /*#__PURE__*/react.createElement(esm_Col, null, "Developed By: @Developer Name")));
}
...
function Layout() {
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(Header, null), /*#__PURE__*/react.createElement(esm_Container, {
    className: "mt-2"
  }, /*#__PURE__*/react.createElement(Outlet, null)), /*#__PURE__*/react.createElement(Footer, null));
}
;// CONCATENATED MODULE: ./src/pages/TodoDetailsPage.js
...
function TodoDetailsPage() {
  var data = useRouteLoaderData('todo-detail');
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(esm_Container, null, /*#__PURE__*/react.createElement("h1", {
    className: "text-center text-capitalize fw-normal fs-2 mb-5"
  }, "Todo Details")), /*#__PURE__*/react.createElement(esm_Container, {
    className: "border-gray border-gray rounded"
  }, /*#__PURE__*/react.createElement(esm_Row, {
    className: "text-capitalize fw-normal px-2 py-3 bglightgreen"
  }, /*#__PURE__*/react.createElement(esm_Col, null, "Title: ", data === null || data === void 0 ? void 0 : data.todolist.title)), /*#__PURE__*/react.createElement(esm_Row, {
    className: "text-capitalize fw-normal px-2 py-3"
  }, /*#__PURE__*/react.createElement(esm_Col, null, "Description: ", data === null || data === void 0 ? void 0 : data.todolist.description)), /*#__PURE__*/react.createElement(esm_Row, {
    className: "text-capitalize fw-normal px-2 py-3"
  }, /*#__PURE__*/react.createElement(esm_Col, null, /*#__PURE__*/react.createElement(Link, {
    to: "edit",
    className: "makebtn px-4 py-2 rounded text-center text-capitalize bglightgreen text-black me-2"
  }, "Edit"), /*#__PURE__*/react.createElement(react_bootstrap_esm_Button, {
    onClick: deleteTodo,
    className: "makebtn pedd rounded text-center text-capitalize delete text-white"
  }, "Delete")))), /*#__PURE__*/react.createElement("br", null), /*#__PURE__*/react.createElement(Link, {
    to: "..",
    relative: "path"
  }, "Back"));
}
var TodoDetailsPage_loader = function loader(_x) {
  return (_ref2 = _ref2 || _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee(_ref) {
    var request, params, todoID, response;
    return regenerator_default().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
var TodoDetailsPage_action = function action(_x2) {
  return (_ref4 = _ref4 || _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee2(_ref3) {
    var request, params, method, todoId, response;
    return regenerator_default().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
...
;// CONCATENATED MODULE: ./src/pages/Error.js
...
function Error_Error() {
  ...
  var defultError = 'Something went wrong.';
  if (error.status === 500) {
    defultError = JSON.parse(errorData).message;
  }
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(esm_Container, {
...
;// CONCATENATED MODULE: ./src/layout/TodoListRootLayout.js


function TodoListRootLayout() {
  return /*#__PURE__*/react.createElement(Outlet, null);
}
;// CONCATENATED MODULE: ./src/pages/EditTodo.js
...
function EditTodo() {
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(esm_Container, null, /*#__PURE__*/react.createElement("h1", {
    className: "text-center text-capitalize fw-normal fs-2 mb-5"
  }, "Edit Todo")), /*#__PURE__*/react.createElement(FormTodo, {
    method: "PATCH",
    todo: data
  }));
}
;// CONCATENATED MODULE: ./src/pages/AddListViaFam.js


var AddListViaFam_ref2;
...
function AddListViaFam() {
  var fetcher = useFetcher();
  var data = fetcher.data,
    state = fetcher.state;
  var _useState = (0,react.useState)(""),
    _useState2 = _slicedToArray(_useState, 2),
    stateFetch = _useState2[0],
    setStateFetch = _useState2[1];
  (0,react.useEffect)(function () {
    if (state === 'idle' && data !== null && data !== void 0 && data.message) {
      setStateFetch(data === null || data === void 0 ? void 0 : data.message);
    }
  }, [data, state]);
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(esm_Container, null, /*#__PURE__*/react.createElement("h1", {
    className: "text-center text-capitalize fw-normal fs-2 mb-5"
  }, "Add Todo Via Fetcher")), /*#__PURE__*/react.createElement(esm_Container, null, /*#__PURE__*/react.createElement(esm_Row, null, /*#__PURE__*/react.createElement(esm_Col, {
    className: "p-2"
  }, stateFetch)), /*#__PURE__*/react.createElement(fetcher.Form, {
    method: "post",
    action: "/addtodolistviafetcher"
  }, /*#__PURE__*/react.createElement(esm_Form.Group, {
    className: "mb-3",
    controlId: "exampleForm.ControlInput1"
  }, /*#__PURE__*/react.createElement(esm_Form.Label, null, "Title"), /*#__PURE__*/react.createElement(esm_Form.Control, {
...
var AddListViaFam_action = function action(_x) {
  return (AddListViaFam_ref2 = AddListViaFam_ref2 || _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee(_ref) {
    var request, params, data, bodyData, url, response;
    return regenerator_default().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 14:
          return _context.abrupt("return", {
            message: "todo submited successfully"
          });
        case 15:
        case "end":
          return _context.stop();
...
function App() {
  var createRouteObjects = createBrowserRouter([{
    path: '/',
    element: /*#__PURE__*/react.createElement(Layout, null),
    errorElement: /*#__PURE__*/react.createElement(Error_Error, null),
    children: [{
      index: true,
      ...
      children: [{
        index: true,
        element: /*#__PURE__*/react.createElement(TodoListPage, null),
        loader: loader,
        action: action
      }, {
        path: ':todoId',
        id: 'todo-detail',
        loader: TodoDetailsPage_loader,
        children: [{
          index: true,
          element: /*#__PURE__*/react.createElement(TodoDetailsPage, null),
          action: TodoDetailsPage_action
        }, {
          path: 'edit',
          element: /*#__PURE__*/react.createElement(EditTodo, null),
          action: FormTodo_action
        }]
      }]
    }, {
      path: 'addtodolist',
      element: /*#__PURE__*/react.createElement(AddTodoListPage, null),
      action: FormTodo_action
    }, {
      path: 'addtodolistviafetcher',
      element: /*#__PURE__*/react.createElement(AddListViaFam, null),
      action: AddListViaFam_action
    }]
  }]);
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(RouterProvider, {
    router: createRouteObjects
  }));
}
